...
Texto descriptivo a pie de imagen
```
...
En [este enlace](https://github.com/rcfdtools/R.LTWB/tree/main/activity/CNEStation) encontrarás un ejemplo con los elementos descritos anteriormente que hacen parte de una clase o actividad.
...
Para la grabación de clases en primera persona, se promueve el uso de la campaña publicitaria _Soy Escuela,_ pero a nivel de cada facultad o programa.
