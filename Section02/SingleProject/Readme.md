...
| Incluí en mi repositorio un archivo de más de 100 MB y al realizar el _Push_ GitHub devuelve un error indicando que no puede actualizar los cambios. ¿Cuál es la solución? | Lo primero es crear una copia comprimida local del repositorio, luego revertir o eliminar el _Commit / Push_ donde se incluyó el archivo, luego incluir el archivo en la lista de archivos a ingnorar dentro de `.gitignore`, comprimir el archivo en partes de 95 MB y volver a realizar el _1_ para cargar los archivos.                                                                                                                                                             | 
